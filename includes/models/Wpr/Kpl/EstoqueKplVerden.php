...
class Model_Wpr_Kpl_EstoqueKplVerden extends Model_Wpr_Kpl_KplWebService {	
	...
	function ProcessaEstoqueWebservice ( $request, $dadosCliente ) {
		...
		$this->_magento = new Model_Wpr_Magento_Estoque( $dadosCliente['MAGENTO_WSDL'],$dadosCliente['MAGENTO_USUARIO'], $dadosCliente['MAGENTO_SENHA'] );
