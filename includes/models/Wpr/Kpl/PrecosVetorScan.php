...
class Model_Wpr_Kpl_PrecosVetorScan extends Model_Wpr_Kpl_KplWebService {
	...
	*/
	...
	function ProcessaPrecosWebservice ( $request, $dadosCliente ) {
		...
		$this->_magento = new Model_Wpr_Magento_PrecosVetorScan( $dadosCliente ['MAGENTO_WSDL'], $dadosCliente ['MAGENTO_USUARIO'], $dadosCliente ['MAGENTO_SENHA'] );
