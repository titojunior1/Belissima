...
class Model_Wpr_Kpl_StatusPedidoCreaTech extends Model_Wpr_Kpl_KplWebService {	
	...
	function ProcessaStatusWebservice ( $request, $dadosCliente ) {
		...
		$this->_magento = new Model_Wpr_Magento_StatusCreaTech( $dadosCliente ['MAGENTO_WSDL'], $dadosCliente ['MAGENTO_USUARIO'], $dadosCliente ['MAGENTO_SENHA'] );
