 ...
 *        
 */
class Model_Wpr_Magento_PedidosVerden extends Model_Wpr_Magento_MagentoWebService {
	...
	*/
	...
	function ProcessaPedidosWebservice($request, $dadosCliente) {
		...
		foreach ( $request as $i => $d ) {
			...
			// Dados do Endereço
			list ( $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['Endereco'] ['Logradouro'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['Endereco'] ['NumeroLogradouro'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['Endereco'] ['ComplementoEndereco'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['Endereco'] ['Bairro'] ) = explode ( "\n", $infosAdicionaisPedido->shipping_address->street );
			...
			list ( $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['EndCobranca'] ['Logradouro'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['EndCobranca'] ['NumeroLogradouro'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['EndCobranca'] ['ComplementoEndereco'], $dadosCliente [$i] ['Cliente'] ['DadosClientes'] ['EndCobranca'] ['Bairro'] ) = explode ( "\n", $infosAdicionaisPedido->billing_address->street );
			...
			// Dados do Endereço
			list ( $dadosPedido [$i] ['DestLogradouro'], $dadosPedido [$i] ['DestNumeroLogradouro'], $dadosPedido [$i] ['DestComplementoEndereco'], $dadosPedido [$i] ['DestBairro'] ) = explode ( "\n", $infosAdicionaisPedido->shipping_address->street );
